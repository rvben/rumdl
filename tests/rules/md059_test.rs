...
use rumdl_lib::rules::MD059TableFormat;
...
#[test]
fn test_md059_complex_regex_in_inline_code() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_table_with_trailing_newline() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_table_without_content_rows() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_none_style() {
    let rule = MD059TableFormat::new(true, "none".to_string(), None);
...
#[test]
fn test_md059_single_column_table() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_table_in_context() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_warning_messages() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
    ...
    for warning in &warnings {
        ...
        assert_eq!(warning.rule_name, Some("MD059".to_string()));
        assert!(warning.fix.is_some(), "Each warning should have a fix");
    }
}

#[test]
fn test_md059_escaped_pipes() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_very_long_content() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
...
#[test]
fn test_md059_minimum_width_with_alignment_indicators() {
    let rule = MD059TableFormat::new(true, "aligned".to_string(), Some(120));
