...
check-links:
	...
	$(LYCHEE) --no-progress --config .lychee.toml --remap 'https://rumdl.dev/(.+?)/?(?:#.*)?$$ file://$(CURDIR)/docs/$$1.md' --remap 'https://raw.githubusercontent.com/rvben/rumdl/main/(.+) file://$(CURDIR)/$$1' 'README.md' 'docs/**/*.md'
