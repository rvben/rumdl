...
- 🔍 **<!-- RULE_COUNT -->79<!-- /RULE_COUNT --> lint rules** covering common Markdown issues
...
rumdl implements <!-- RULE_COUNT -->79<!-- /RULE_COUNT --> lint rules for Markdown files. Here are some key rule categories:
