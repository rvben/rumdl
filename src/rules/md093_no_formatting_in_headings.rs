//! Rule MD093: inline formatting inside a heading.
//!
...
pub struct MD093NoFormattingInHeadings {
    config: MD093Config,
}

impl MD093NoFormattingInHeadings {
    fn from_config_struct(config: MD093Config) -> Self {
        Self { config }
    }
...
impl Rule for MD093NoFormattingInHeadings {
    ...
    crate::impl_rule_config_methods!(MD093Config);
}
