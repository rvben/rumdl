...
| Rules           | <!-- RULE_COUNT -->88<!-- /RULE_COUNT --> built in, opt-in ones enabled in config | 65 built in, plus custom regex replacements and commands |
...
- [Rules Reference](rules.md) - the complete list of rumdl's <!-- RULE_COUNT -->88<!-- /RULE_COUNT --> rules
