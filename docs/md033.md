...
- Tags with extra attributes (class, id, style, target, onclick, width, height, etc.) are not converted
...
- Tags with attributes beyond href/src/alt/title are not converted (attributes might be significant)
