...
Case 1 requires at least one outer pipe, either leading or trailing, on each
orphan row. Bare pipe-delimited lines are not reported because they are
indistinguishable from prose and unsafe to merge automatically.
