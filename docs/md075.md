...
This rule can automatically fix **Case 1** (orphaned rows) by removing the blank lines between the table and the orphaned rows, merging them into a single table.
