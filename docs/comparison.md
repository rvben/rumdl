...
| --------------------- | ------------- | -------- | ----------------------------------------- | -------- | -------- | ----------------------- | ------------ | --- |
| **rumdl**             | Lint + Format | Rust     | <!-- RULE_COUNT -->87<!-- /RULE_COUNT --> | Yes      | Built in | TOML, JSON, YAML        | No           | Yes |
...
**rumdl** implements all 53 markdownlint rules plus <!-- RULE_COUNT_ADDITIONAL -->34<!-- /RULE_COUNT_ADDITIONAL --> additional rules (<!-- RULE_COUNT -->87<!-- /RULE_COUNT --> total). It supports
...
- [Rules Reference](rules.md) — complete list of rumdl's <!-- RULE_COUNT -->87<!-- /RULE_COUNT --> rules
