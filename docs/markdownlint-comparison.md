...
- **Unique Features**: <!-- RULE_COUNT_ADDITIONAL -->34<!-- /RULE_COUNT_ADDITIONAL --> additional rules (MD057, MD061-<!-- RULE_MAX -->MD093<!-- /RULE_MAX -->), built-in LSP server, VS Code extension, and built-in Markdown flavors
...
rumdl implements **<!-- RULE_COUNT -->87<!-- /RULE_COUNT --> rules total**: all 53 markdownlint rules plus <!-- RULE_COUNT_ADDITIONAL -->34<!-- /RULE_COUNT_ADDITIONAL --> unique rules.
...
rumdl implements <!-- RULE_COUNT_ADDITIONAL -->34<!-- /RULE_COUNT_ADDITIONAL --> additional rules not found in markdownlint:
...
| ------------------------ | ------------------ | --------------------------- |
| **Core Functionality**   |                    |                             |
| Rule count               | 53 implemented     | <!-- RULE_COUNT -->87<!-- /RULE_COUNT --> (53 compatible + <!-- RULE_COUNT_ADDITIONAL -->34<!-- /RULE_COUNT_ADDITIONAL --> new) |
| Auto-fix                 | ✅                 | ✅                          |
