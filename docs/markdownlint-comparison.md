...
- **Unique Features**: <!-- RULE_COUNT_ADDITIONAL -->33<!-- /RULE_COUNT_ADDITIONAL --> additional rules (MD057, MD061-<!-- RULE_MAX -->MD092<!-- /RULE_MAX -->), built-in LSP server, VS Code extension, and built-in Markdown flavors
...
rumdl implements **<!-- RULE_COUNT -->86<!-- /RULE_COUNT --> rules total**: all 53 markdownlint rules plus <!-- RULE_COUNT_ADDITIONAL -->33<!-- /RULE_COUNT_ADDITIONAL --> unique rules.
...
rumdl implements <!-- RULE_COUNT_ADDITIONAL -->33<!-- /RULE_COUNT_ADDITIONAL --> additional rules not found in markdownlint:
...
| MD092  | No formatting in headings      | Flags inline formatting inside a heading (opt-in)          |

**Opt-in rules:** MD060, MD063, MD070, MD072, MD073, MD074, MD080, MD082,
MD083, MD084, MD085, MD087, MD088, MD089, MD090, MD091, and MD092 are disabled by
default. Enable them explicitly in your configuration.
...
| ------------------------ | ------------------ | --------------------------- |
| **Core Functionality**   |                    |                             |
| Rule count               | 53 implemented     | <!-- RULE_COUNT -->86<!-- /RULE_COUNT --> (53 compatible + <!-- RULE_COUNT_ADDITIONAL -->33<!-- /RULE_COUNT_ADDITIONAL --> new) |
| Auto-fix                 | ✅                 | ✅                          |
