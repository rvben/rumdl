...
- **rumdl**: Combined linter and formatter with <!-- RULE_COUNT -->86<!-- /RULE_COUNT --> rules plus formatting
...
| Linting rules   | ❌                        | ✅ <!-- RULE_COUNT -->86<!-- /RULE_COUNT --> rules                     |
...
rumdl provides <!-- RULE_COUNT -->86<!-- /RULE_COUNT --> linting rules that mdformat does not have:
...
| Markdown linting        | ❌                 | ✅ <!-- RULE_COUNT -->86<!-- /RULE_COUNT --> rules            |
