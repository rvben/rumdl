...
- **rumdl**: Combined linter and formatter with <!-- RULE_COUNT -->85<!-- /RULE_COUNT --> rules plus formatting
...
| Linting rules   | ❌                        | ✅ <!-- RULE_COUNT -->85<!-- /RULE_COUNT --> rules                     |
...
rumdl provides <!-- RULE_COUNT -->85<!-- /RULE_COUNT --> linting rules that mdformat does not have:
...
```toml
[global]
flavor = "gfm"  # or: mkdocs, mdx, pandoc, quarto, obsidian, kramdown, azure_devops, myst, hugo, mdg, gh-aw
```
...
| Markdown linting        | ❌                 | ✅ <!-- RULE_COUNT -->85<!-- /RULE_COUNT --> rules            |
