...
| Linting rules   | ❌                        | ✅ <!-- RULE_COUNT -->78<!-- /RULE_COUNT --> rules                     |
...
rumdl provides <!-- RULE_COUNT -->78<!-- /RULE_COUNT --> linting rules that mdformat does not have:
...
| Markdown linting        | ❌                 | ✅ <!-- RULE_COUNT -->78<!-- /RULE_COUNT --> rules            |
