...
-   :mag:{ .lg .middle } **<!-- RULE_COUNT -->81<!-- /RULE_COUNT --> lint rules**
...
- :mag: **<!-- RULE_COUNT -->81<!-- /RULE_COUNT --> lint rules** covering common Markdown issues
...
-   [:octicons-book-24: **Rules Reference**](rules.md)
    ...
    Explore all <!-- RULE_COUNT -->81<!-- /RULE_COUNT --> linting rules with examples.
