...
A setext heading is made of its text lines and the underline below them, and each of those lines is checked on its own: an indented text line or an indented underline is reported and moved to the beginning of the line.
