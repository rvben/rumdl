...
| Rule IDs (`MD001`-`MD092`)                                                                                                                                             | **Stable**                               | IDs are permanent and are never reused. New rules receive new IDs. Markdownlint-compatible gaps are preserved.                                                                                                                                                                                   |
...
| Markdown flavors (`standard`, `gfm`, `mkdocs`, `mdx`, `pandoc`, `quarto`, `obsidian`, `kramdown`, `azure_devops`, `myst`, `hugo`, `mdg`)                               | **Stable with caveats**                  | Flavor detection and behavior are refined over time.                                                                                                                                                                                                                                             |
| Preview features (`code-block-tools`, `gh-aw` flavor)                                                                                                                  | **Experimental**                         | May change or be removed without a deprecation cycle. Documented as preview where they appear.                                                                                                                                                                                                   |
| Opt-in rules (`MD060`, `MD063`, `MD070`, `MD072`, `MD073`, `MD074`, `MD080`, `MD082`, `MD083`, `MD084`, `MD085`, `MD087`, `MD088`, `MD089`, `MD090`, `MD091`, `MD092`) | **Supported, off by default**            | Enable with `extend-enable`. These are disabled by default because they are opinionated or can produce large diffs, not because they are experimental.                                                                                                                                           |
