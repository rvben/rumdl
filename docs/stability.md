...
| Rule IDs (`MD001`-`MD091`)                                                                                                                                    | **Stable**                               | IDs are permanent and are never reused. New rules receive new IDs. Markdownlint-compatible gaps are preserved.                                                                                                                                                                                   |
...
| Opt-in rules (`MD060`, `MD063`, `MD070`, `MD072`, `MD073`, `MD074`, `MD080`, `MD082`, `MD083`, `MD084`, `MD085`, `MD087`, `MD088`, `MD089`, `MD090`, `MD091`) | **Supported, off by default**            | Enable with `extend-enable`. These are disabled by default because they are opinionated or can produce large diffs, not because they are experimental.                                                                                                                                           |
