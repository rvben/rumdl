...
reflow_mode = "default"  # Reflow mode: "default", "normalize", or "sentence-per-line" (default: "default")
```
...
code_blocks = true  # Still check code blocks
...
```toml
[MD013]
line_length = 0  # Disable all line length checks
reflow = true
reflow_mode = "sentence-per-line"
```
