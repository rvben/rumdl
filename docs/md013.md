...
- `length-mode`: How to calculate line length (default: `"visual"`):
  - `"visual"` : Count visual display width (emoji = 2 columns, CJK characters = 2 columns) - **recommended and default** . This correctly handles international content and matches terminal display
    width.
